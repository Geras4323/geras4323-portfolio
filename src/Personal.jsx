      ...
      <section className="w-full h-full text-primary flex flex-col justify-around items-center   lg:flex-row lg:justify-evenly">
        ...
        <section className="w-full h-12 flex flex-row justify-center space-x-8   lg:h-14 lg:w-64">
          <a href="https://github.com/Geras4323">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  className="h-full   hover:drop-shadow-md hover:scale-110   transition-all duration-300 ease-in-out">
          ...
          <a href="https://www.linkedin.com/in/germ%C3%A1n-edgardo-g%C3%B6hringer-726405234/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-full fill-current text-blue-700   hover:drop-shadow-md hover:scale-110   transition-all duration-300 ease-in-out">
          ...
          <ul className="h-auto text-md flex flex-row space-x-6   lg:text-lg lg:font-bold">
            <li>
              <div className="h-full flex flex-col items-center justify-between">
                <img src="https://vitejs.dev/logo.svg" className="w-10 drop-shadow-md   lg:w-14"/>
                <span>Vite</span>
              </div>
            </li>
            <li>
